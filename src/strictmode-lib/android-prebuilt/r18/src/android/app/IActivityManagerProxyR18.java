...
public class IActivityManagerProxyR18 implements IActivityManager {
    ...
    public IActivityManagerProxyR18(IActivityManager manager, DataProxy<ViolationInfo> violationProxy) {
        mTo = manager;
  ...
  public int broadcastIntent(IApplicationThread paramIApplicationThread,
      Intent paramIntent, String paramString1, IIntentReceiver paramIIntentReceiver,
      int paramInt1, String paramString2, Bundle paramBundle, String paramString3,
      int paramInt2, boolean paramBoolean1, boolean paramBoolean2, int paramInt3)
      throws RemoteException {
    return mTo.broadcastIntent(paramIApplicationThread,
        paramIntent, paramString1, paramIIntentReceiver,
    paramInt1, paramString2, paramBundle, paramString3,
    paramInt2, paramBoolean1, paramBoolean2, paramInt3);
  }
  ...
  public int startActivities(IApplicationThread paramIApplicationThread, String paramString,
      Intent[] paramArrayOfIntent, String[] paramArrayOfString,
      IBinder paramIBinder, Bundle paramBundle, int paramInt)
      throws RemoteException {
    return mTo.startActivities(paramIApplicationThread, paramString,
        paramArrayOfIntent, paramArrayOfString,
        paramIBinder, paramBundle, paramInt);
  }


  public int startActivity(IApplicationThread paramIApplicationThread, String paramString1,
      Intent paramIntent, String paramString2, IBinder paramIBinder, String paramString3,
      int paramInt1, int paramInt2, String paramString4,
      ParcelFileDescriptor paramParcelFileDescriptor, Bundle paramBundle)
      throws RemoteException {
    return mTo.startActivity(paramIApplicationThread, paramString1,
        paramIntent, paramString2, paramIBinder, paramString3,
        paramInt1, paramInt2, paramString4,
        paramParcelFileDescriptor, paramBundle);
  }


  public WaitResult startActivityAndWait(IApplicationThread paramIApplicationThread,
      String paramString1, Intent paramIntent, String paramString2, IBinder paramIBinder,
      String paramString3, int paramInt1, int paramInt2, String paramString4,
      ParcelFileDescriptor paramParcelFileDescriptor, Bundle paramBundle, int paramInt3)
      throws RemoteException {
    return mTo.startActivityAndWait(paramIApplicationThread,
        paramString1, paramIntent, paramString2, paramIBinder,
        paramString3, paramInt1, paramInt2, paramString4,
        paramParcelFileDescriptor, paramBundle, paramInt3);
  }


  public int startActivityAsUser(IApplicationThread paramIApplicationThread,
      String paramString1, Intent paramIntent, String paramString2, IBinder paramIBinder,
      String paramString3, int paramInt1, int paramInt2, String paramString4,
      ParcelFileDescriptor paramParcelFileDescriptor, Bundle paramBundle, int paramInt3)
      throws RemoteException {
    return mTo.startActivityAsUser(paramIApplicationThread,
        paramString1, paramIntent, paramString2, paramIBinder,
        paramString3, paramInt1, paramInt2, paramString4,
        paramParcelFileDescriptor, paramBundle, paramInt3);
  }
  ...
  public int startActivityWithConfig(IApplicationThread paramIApplicationThread,
      String paramString1, Intent paramIntent, String paramString2, IBinder paramIBinder,
      String paramString3, int paramInt1, int paramInt2, Configuration paramConfiguration,
      Bundle paramBundle, int paramInt3)
      throws RemoteException {
    return mTo.startActivityWithConfig(paramIApplicationThread,
        paramString1, paramIntent, paramString2, paramIBinder,
        paramString3, paramInt1, paramInt2, paramConfiguration,
        paramBundle, paramInt3);
  }


  public boolean startInstrumentation(ComponentName paramComponentName,
      String paramString, int paramInt1, Bundle paramBundle,
      IInstrumentationWatcher paramIInstrumentationWatcher,
      IUiAutomationConnection paramIUiAutomationConnection, int paramInt2)
      throws RemoteException {
    return mTo.startInstrumentation(paramComponentName,
        paramString, paramInt1, paramBundle,
        paramIInstrumentationWatcher,
        paramIUiAutomationConnection, paramInt2);
  }
  ...
  public void hang(IBinder paramIBinder, boolean paramBoolean)
      throws RemoteException {
    mTo.hang(paramIBinder, paramBoolean);
  }

  public void killUid(int paramInt, String paramString)
      throws RemoteException {
    mTo.killUid(paramInt, paramString);
  }

  public void reportTopActivityExtras(IBinder paramIBinder, Bundle paramBundle)
      throws RemoteException {
    mTo.reportTopActivityExtras(paramIBinder, paramBundle);
  }

  public Bundle getTopActivityExtras(int paramInt)
      throws RemoteException {
    return mTo.getTopActivityExtras(paramInt);
  }

  public String getLaunchedFromPackage(IBinder paramIBinder)
      throws RemoteException {
    return mTo.getLaunchedFromPackage(paramIBinder);
  }

  public Intent getIntentForIntentSender(IIntentSender paramIIntentSender)
      throws RemoteException {
    return mTo.getIntentForIntentSender(paramIIntentSender);
  }

  public void setUserIsMonkey(boolean paramBoolean)
      throws RemoteException {
    mTo.setUserIsMonkey(paramBoolean);
  }
