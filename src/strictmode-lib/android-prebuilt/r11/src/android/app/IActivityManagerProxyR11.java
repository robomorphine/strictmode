...
public class IActivityManagerProxyR11 implements IActivityManager {
    ...
    public IActivityManagerProxyR11(IActivityManager manager, 
    ...
    public void publishService(IBinder arg0, Intent arg1, IBinder arg2) throws RemoteException {
        mTo.publishService(mBinderProxy.handle(arg0), mIntentProxy.handle(arg1),
